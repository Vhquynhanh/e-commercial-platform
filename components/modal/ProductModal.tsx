...
export default function ProductModal() {
  ...
  return (
    ...
    >
      <div className="background-light100_dark100 rounded-2xl max-w-4xl w-full max-h-[90vh] flex flex-col overflow-hidden">
        {/* Header */}
        <div className="background-light100_dark100 border-b border-light200_dark600 p-6 flex items-center justify-between flex-shrink-0">
